...
* 1/ Pre-test *
* =========== *
log using "SumCorrVif.log", replace
* Descriptive statistics
sum comov lnTI_1 lnTI_2 sanctions_any TI1xSanc

* Correlation matrix
pwcorr comov lnTI_1 lnTI_2 sanctions_any TI1xSanc
...
outreg2 using "mmqr_baseline.doc", replace label sortvar(`rowoder')
...
outreg2 using "mmqr_trade.doc", replace label sortvar(`rowoder')
...
outreg2 using "mmqr_financial.doc", replace label sortvar(`rowoder')

* Robust *
local rowoder "lnTI_2 sanctions_any TI1xSanc"
mmqreg comov lnTI_2 sanctions_any TI2xSanc, abs(od year) q(0.25 0.50 0.75 0.90)
outreg2 using "mmqr_robust.doc", replace label sortvar(`rowoder')
